...
"""
Ce module gère les conditions initiales et propose plusieurs scénarios prédéfinis.
"""
...
def earth_sun():
    ...
    return {
        ...
        "t_end": 1.0,   # 1 an
        "N_steps": 20000,
        "masses":     [1.0, 3e-6],           # Soleil, Terre
        "positions":  [[0.0, 0.0], [1.0, 0.0]],
        "velocities": [[0.0, 0.0], [0.0, 2*3.141592]]  # ~2π UA/an
    }
